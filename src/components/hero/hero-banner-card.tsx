      ...
      >
        <div
          className={cn('w-full', {
            ...
            'max-w-[480px] md:max-w-[580px] lg:px-20 xl:max-w-[700px]': variant === 'slider-4',
          })}
        >
          <div
          ...
          >
            ...
            <h2
              className={cn('mt-2 text-4xl font-semibold leading-8 md:text-4xl', {
            ...
            {banner.btnText && (
              <Link
                ...
                className={cn(
                  ...
                  {
                    'bg-primary text-white hover:bg-primary': variant !== 'antique',
    ...
    <Link to={`${banner.btnUrl}`}>
      <div
        ...
        style={{
          ...
          backgroundPosition: variant === 'antique' ? 'left bottom -10px' : 'center center',
        }}
      ></div>
    </Link>
  )
