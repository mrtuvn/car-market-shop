...
const ProductDetailsPage = () => {
  ...
  const cartItemDetails = useAppSelector((state) => selectCartItemDetails(state, Number(id)))
      ...
      <div className="grid-cols-10 gap-8 lg:grid">
        ...
        <div className="col-span-5 shrink-0">
          ...
          <div className="mb-4 flex space-x-1 text-gray-500">
            ...
            {reviews !== undefined && (
              <span className="text-[13px] leading-4">({reviews.length} review)</span>
            )}
          </div>
          ...
          <div className="my-8 text-3xl text-gray-500">
            <div className="flex gap-x-2">
              ...
              {basePrice && <div className="text-gray-400 line-through">{basePrice}</div>}
            </div>
          ...
          <div className="space-y-7 pt-4">
            ...
            <div className="flex gap-2">
              <Button onClick={handleAddToCart} className="w-64 px-1.5" loading={addToCartLoader}>
                <CartIcon color="#ffffff" className="mr-3" />
                Add To Cart
              </Button>

              <CompareButton product={product} className="flex w-14 items-center justify-center" />
              <WishlistButton product={product} className="flex w-14 items-center justify-center" />
            </div>
          </div>
        </div>
      </div>
